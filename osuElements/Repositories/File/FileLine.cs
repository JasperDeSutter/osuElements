...
namespace osuElements.Repositories.File
{
    public class FileLine<TModel, TValue> : IFileLine<TModel>
    {
        public FileLine(Expression<Func<TModel, TValue>> propertySelector, TValue defaultValue = default(TValue)) {
            Value = (PropertyInfo)((MemberExpression)propertySelector.Body).Member;
            Key = Value.Name;
            DefaultValue = defaultValue;
            _type = typeof(TValue);
        }
        public FileLine(string property, TValue defaultvalue = default(TValue)) {
            Value = typeof(TModel).GetRuntimeProperty(property);
            Key = property;
            DefaultValue = defaultvalue;
            _type = typeof(TValue);
        }
        ...
        public virtual bool IsDefault(TModel model) {
            return Value != null && Equals((TValue)Value.GetValue(model), DefaultValue);
        }
        ...
        public virtual string GetLine(TModel model) {
            var value = Value.GetValue(model);
        ...
        public virtual object GetValue(string value) {
            ...
            if (_type == typeof(ComboColour) || _type == typeof(ComboColour?))
                return ComboColour.Parse(value);
